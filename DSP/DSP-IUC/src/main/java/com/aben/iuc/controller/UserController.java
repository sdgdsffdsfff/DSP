...
public class UserController {
	...
	public String list(Page page, String keywords, String realname,Long organizationId,Map<String, Object> map) {
		List<User> users ;
...
//		}
		...
		users = userService.findByEntityManager(page,keywords,realname,organizationId);
		List<Organization> organzations = organizationService.findAll();
//		if(null == organizationId) organizationId = 0L;
//		Organization o = organizationService.get(organizationId);
		map.put("organizationId", organizationId);
//		map.put("o", o);
		map.put("organzations", organzations);
	...
	public @ResponseBody String reset(@PathVariable String type, @PathVariable Long userId) {
		...
		if (type.equals("password")) {
			user.setPlainPassword("888888");
			ajaxObject.setMessage("重置密码成功，默认为888888！"); 
